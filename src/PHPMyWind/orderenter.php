	...
	<form name="form" id="form" method="post" action="">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shoppingcart">
			...
			<tr>
				...
				<td><?php
					$r = $dosql->GetOne("SELECT `classname`,`postprice` FROM `#@__postmode` WHERE `id`=".$orderinfo['postmode']);
					echo $r['classname'];
					?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><?php
					$r = $dosql->GetOne("SELECT `classname` FROM `#@__getmode` WHERE `id`=".$orderinfo['getmode']);
					echo $r['classname'];
					?></td>
			</tr>
			<tr>
