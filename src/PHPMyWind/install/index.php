...
else if($s == 3)
{
	...
	if($_POST['s'] == 3)
	{
		...
		if($conn)
		{
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_copyright','版权信息','0','bstring','Copyright © 2010 - 2014 phpMyWind.com All Rights Reserved','8');
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_oauth','开启一键登陆','2','bool','Y','45');
